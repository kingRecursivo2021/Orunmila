...
class View
{
     ...
     *            El nombre del archivo de la vista, sin la extensión ".php".
     * @param array $__data
     *            Array asociativo con los valores que quieren proveerse a la vista. Las claves son los nombres de las variables que van a proporcionarse.
     * @param null|string $layout
     *            El nombre del archivo del layout que quiere usarse. De no especificarse, se usa el default.
