...
class Route
{
     ...
     *
     * @param string $method
     *            El verbo HTTP de la ruta. Puede ser 'GET', 'POST', 'PUT', 'DELETE'.
     * @param string $url
     *            La url de la ruta.
     * @param string $controller
     *            El método del controller que lo va a manejar. La notación es: "NombreController@nombreMétodo".
     */
    ...
    public static function exists($method, $url)
    {
        ...
        // print_r($routes);
        // print_r("<Br />");
        // Verificamos si existe la ruta tal cual me la piden.
